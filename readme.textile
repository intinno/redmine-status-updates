...
This Fork integrates redmine-status-updates with redmine_messenger":http://github.com/intinno/redmine_messenger so that developers can update their status via jabber.
